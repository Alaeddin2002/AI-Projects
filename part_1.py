    ...
    while Q.is_empty()==False:#game_ending(state)==False:
        ...
        if curr_node.get_depth()==depth:
            if utility == "E":
                ...
                val = hurdle_utility(curr_node.get_state())
                curr_node.set_utility(val)
...
if __name__ == '__main__':
    ...
    parser.add_argument('U1',help='utility value to use choose from C,F,E,H')#Take utility for white
    parser.add_argument('U2',help='utility value to use choose from C,F,E,H')#Take utility for Black
